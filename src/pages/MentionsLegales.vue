    ...
    <section class="section">
      <div class="container">
        <div class="block">
          ...
          <br />
          personnelles collectées Lors de l'utilisation de notre service, nous
          pouvons vous demander de nous fournir certaines informations
          personnellement identifiables qui peuvent être utilisées pour vous
          contacter ou vous identifier. Les informations personnellement
          identifiables peuvent inclure, sans s'y limiter :
          <br />
          Adresse e-mail
          <br />
          Prénom et nom
        ...
        <div class="block">
          ...
          utilisons peuvent inclure : des
          <br />
          cookies ou des cookies de navigateur. Un cookie est un petit fichier
          placé sur votre appareil. Vous pouvez demander à Votre navigateur de
          refuser tous les Cookies ou d'indiquer lorsqu'un Cookie est envoyé.
          Cependant, si vous n'acceptez pas les cookies, vous ne pourrez
          peut-être pas utiliser certaines parties de notre service. À moins que
          vous n'ayez ajusté les paramètres de votre navigateur pour qu'il
          refuse les cookies, notre service peut utiliser des cookies.
          <br />
          Cookies Flash. Certaines fonctionnalités de notre Service peuvent
          ...
          de navigateur. Pour plus d'informations sur la façon dont vous pouvez
          supprimer les cookies Flash, veuillez lire « Où puis-je modifier les
          paramètres de désactivation ou de suppression des objets partagés
          locaux ? » disponible sur
          https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_
          Balises Web. Certaines sections de notre Service et de nos e-mails
          ...
          pixel) qui permettent à la Société, par exemple, de compter les
          utilisateurs qui ont visité ces pages. ou ouvert un e-mail et pour
          ...
          certaines de ses fonctionnalités. Ils aident à authentifier les
          utilisateurs et à empêcher l'utilisation frauduleuse des comptes
          d'utilisateurs. Sans ces cookies, les services que vous avez demandés
          ...
          l'utilisation de cookies sur le site Web. <br />
          Cookies de fonctionnalité <br />
          Cookies de fonctionnalité <br />
          Administrés par : Nous <br />
          Objectif : ces cookies nous permettent de mémoriser les choix que vous
          faites lorsque vous utilisez le site Web, tels que la mémorisation de
          vos informations de connexion ou de votre préférence linguistique. Le
          but de ces Cookies est de Vous offrir une expérience plus personnelle
          et de Vous éviter d'avoir à ressaisir vos préférences à chaque fois
          que Vous utilisez le Site. <br />
          Pour plus d'informations sur les cookies que nous utilisons et vos
          choix concernant les cookies, veuillez visiter notre Politique de
          cookies ou la section Cookies de notre Politique de confidentialité.
          <br />Utilisation de vos données personnelles <br />
          ...
          l'utilisation de notre service. <br />
          Pour gérer Votre Compte : pour gérer Votre inscription en tant
          ...
          Service qui Vous sont accessibles en tant qu'utilisateur enregistré.
          <br />
          Pour l'exécution d'un contrat : l'élaboration, la conformité et
          l'exécution du contrat d'achat des produits, articles ou services que
          Vous avez achetés ou de tout autre contrat avec Nous via le Service.
          <br />
          ...
          relatives aux fonctionnalités, produits ou services contractuels, y
          compris les mises à jour de sécurité, lorsque cela est nécessaire ou
          raisonnable pour leur mise en œuvre. <br />
          ...
          nous proposons et similaires à ceux que vous avez déjà achetés ou
          demandés, à moins que vous n'ayez choisi de ne pas recevoir ces
          informations. <br />
          ...
          vente ou transfert de tout ou partie de nos actifs, que ce soit dans
          le cadre d'une entreprise en activité ou dans le cadre d'une faillite,
          liquidation, ou une procédure similaire, dans laquelle les données
          personnelles que nous détenons sur les utilisateurs de nos services
          font partie des actifs transférés. <br />
          À d'autres fins : nous pouvons utiliser vos informations à d'autres
          fins, telles que l'analyse de données, l'identification des tendances
          ...
          produits, nos services, notre marketing et votre expérience. <br />
          Nous pouvons partager vos informations personnelles dans les
          situations suivantes : <br />
          Avec des fournisseurs de services : Nous pouvons partager vos
          informations personnelles avec des fournisseurs de services pour
          ...
          vos informations personnelles dans le cadre de, ou pendant les
          négociations de, toute fusion, vente d'actifs de la société,
          financement ou acquisition de tout ou partie de notre entreprise à une
          autre société. <br />
          Avec les affiliés : nous pouvons partager vos informations avec nos
          affiliés, auquel cas nous exigerons de ces affiliés qu'ils respectent
          cette politique de confidentialité. Les sociétés affiliées comprennent
          Notre société mère et toutes autres filiales, partenaires de
          coentreprise ou autres sociétés que Nous contrôlons ou qui sont sous
          contrôle commun avec Nous. <br />
          Avec des partenaires commerciaux : nous pouvons partager vos
          informations avec nos partenaires commerciaux pour vous proposer
          certains produits, services ou promotions. <br />Avec d'autres
          utilisateurs : lorsque vous partagez des informations personnelles ou
          interagissez d'une autre manière dans les espaces publics avec
          d'autres utilisateurs, ces informations peuvent être consultées par
          tous les utilisateurs et peuvent être diffusées publiquement à
          l'extérieur. <br />
          Avec Votre consentement : Nous pouvons divulguer Vos informations
          personnelles à toute autre fin avec Votre consentement. <br />
        </div>
        ...
        <div class="block">
          ...
          conservées pendant une période de temps plus courte, sauf lorsque ces
          ...
          s'assurer que vos données sont traitées de manière sécurisée et
          ...
          organisation ou un pays à moins que des contrôles adéquats soient en
          place, y compris la sécurité des Vos données et autres informations
          personnelles. <br />
          Divulgation de vos données personnelles <br />
          ...
          transférées et soient soumises à une politique de confidentialité
          différente.
        </div>
        ...
        <div class="block">
          ...
          demandes valables des autorités publiques (par exemple, un tribunal ou
          un organisme gouvernemental).

          <br />
          Autres exigences légales <br />
          ...
          <ul>
            ...
            <li>
              Protéger les sécurité des Utilisateurs du Service ou du public
            </li>
          </ul>
          <br />
        </div>
        ...
        <div class="block">
          ...
          des données personnelles , Contactez nous s'il vous plait. Si nous
          apprenons que nous avons collecté des données personnelles de toute
          ...
          nos serveurs. <br />
          <br />
          Si Nous devons nous fonder sur le consentement comme base légale pour
          le traitement de Vos informations et que Votre pays requiert le
          consentement d'un parent, Nous pouvons exiger le consentement de Votre
          parent avant de collecter et d'utiliser ces informations.
          <br />
        ...
        <div class="block">
          ...
          Notre Service, avant que le changement ne prenne effet et nous
