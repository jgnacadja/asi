  ...
  <Layout>
    <div class="container has-text-centered">
      <section class="section">
        <div class="container">
          <p class="title has-text-primary">Contactez-nous</p>
          <br />
          <div class="subtitle">
            Intégrez le cercle des partenaires de Studely.
            <br />Participez à la concrétisation de milliers de projets
      ...
      <section class="section has-text-centered">
        <div class="columns is-multiline is-centered">
          <div class="column is-12 title has-text-primary">
            Une question ?
            <br />Une proposition de collaboration ?
          </div>
